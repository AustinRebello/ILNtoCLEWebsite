...
def htmlSite(site, porStart):
        ...
        cvg_top10.append(
         ...
         ## Output File List ###
        output_file_cvg = '../../PDFTxtFiles/Top10/Yearly/'+site.upper()+'_yearly.html'
        ## -- ##
        ...
        ## Get Top 10 warmest ##
        #CVG
        query_cvg = ("SELECT Year, Yearly_Temp_Avg FROM climate.yearly_"+site+" where Yearly_Temp_Avg != 'M' ORDER BY Yearly_Temp_Avg+0 DESC, Year DESC;")
        ...
        ## Get Top 10 coldest ##
        #CVG
        query_cvg = ("SELECT Year, Yearly_Temp_Avg FROM climate.yearly_"+site+" where Yearly_Temp_Avg != 'M' ORDER BY Yearly_Temp_Avg+0, Year DESC;")
        cursor.execute(query_cvg)
        row_cvg = cursor.fetchone()
        ...
        ## Get Top 10 wettest ##
        #CVG
        query_cvg = ("SELECT Year, Yearly_Precip_Total FROM climate.yearly_"+site+" where Yearly_Precip_Total != 'M' ORDER BY Yearly_Precip_Total+0 DESC, Year DESC;")
        cursor.execute(query_cvg)
        row_cvg = cursor.fetchone()
        ...
        ## Get Top 10 driest ##
        #CVG
        query_cvg = ("SELECT Year, Yearly_Precip_Total FROM climate.yearly_"+site+" where Yearly_Precip_Total != 'M' ORDER BY Yearly_Precip_Total+0, Year DESC;")
        cursor.execute(query_cvg)
        row_cvg = cursor.fetchone()
        ...
        ## Get Top 10 snowiest ##
        #CVG
        query_cvg = ("SELECT Year, Yearly_Snow_Total FROM climate.yearly_"+site+" where Yearly_Snow_Total != 'M' AND Yearly_Snow_Total != 'T' ORDER BY Yearly_Snow_Total+0 DESC, Year DESC;")
        cursor.execute(query_cvg)
        row_cvg = cursor.fetchone()
        ...
        #CVG
        query_cvg = ("SELECT Year, Yearly_Snow_Total FROM climate.yearly_"+site+" where Yearly_Snow_Total != 'M' AND Yearly_Snow_Total != 'T' ORDER BY Yearly_Snow_Total+0 ASC, Year DESC;")
        cursor.execute(query_cvg)
        row_cvg = cursor.fetchone()
        ...
        pdfkit.from_file( '../../PDFTxtFiles/Top10/Yearly/' + site.upper() + '_yearly.html', '../../PDFTxtFiles/Top10/Yearly/' + site.upper() + '_yearly.pdf')
